...
| Long fuzz evidence | `docs/fuzz-evidence.md` records all 14 registered targets for `FUZZTIME=1h` on paired local ARM/Intel Go 1.26.3 runs for v0.1.2 package-code candidate `2e09774f171dde8c62763d6e35a258b0fef88801`; raw task logs are in `docs/evidence/v012-candidate-20260508/`; earlier Go 1.26.3, Go 1.26.2, and older ARM/Intel runs remain historical evidence. | Repeat if parser, protocol, fuzz harness, dependency, or toolchain changes before release. |
