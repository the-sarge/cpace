...
3. Complete the remaining exact-candidate evidence for issue #33. The dependency/govulncheck, test-inclusive gosec, Capslock, security/spec audit, Go 1.26.4 to Go 1.26.5 vector-stability, paired long-fuzz, and pre-publication GitHub release-control lanes are current for the frozen candidate contract; complete signed-tag Release Validation and post-release verification under issue #237.
