...
The version pins for these tools live in `scripts/go-tool-versions.sh`. Record command versions and results in the relevant evidence docs if the candidate is making a stronger release-readiness claim.
